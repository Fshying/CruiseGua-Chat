...
(but see https://github.com/Fshying/CruiseGua-Chat/issues/31[this issue]).

See https://github.com/Fshying/CruiseGua-Chat/blob/master/test/integration/api_types.py[this file]
...
https://github.com/Fshying/CruiseGua-Chat/issues/25[this issue]).
...
https://github.com/Fshying/CruiseGua-Chat/issues/24[this issue]).
...
https://github.com/Fshying/CruiseGua-Chat/issues/48[this issue]).
...
https://github.com/Fshying/CruiseGua-Chat/issues/45[this issue]).
...
(see https://github.com/Fshying/CruiseGua-Chat/issues/8[this issue]).
