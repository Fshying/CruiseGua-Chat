...
The https://github.com/Fshying/CruiseGua-Chat/blob/master/tools/deploy.sh[deployment script]
...
https://github.com/Fshying/CruiseGua-Chat/issues/new[open an issue in the repository]
